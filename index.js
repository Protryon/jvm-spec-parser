...
function extractSpec(dom) {
    ...
    /*console.log(Object.keys(instructions).map(name => {
        return ```
package com.javaprophet.jasm.instruction.instructions;

import com.javaprophet.jasm.instruction.Instruction;
...
public class ${name} extends Instruction {
    ...
    @Override
    protected Instruction read(DataInputStream in) {
        return null;
    }
